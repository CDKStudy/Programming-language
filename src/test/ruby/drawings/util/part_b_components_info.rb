...
require_relative '../../../../main/ruby/drawings/core/equilateral_triangle'
require_relative '../../../../main/ruby/drawings/core/rectangle'
require_relative '../../../../main/ruby/drawings/core/ellipse'
require_relative '../../../../main/ruby/drawings/core/image'
require_relative '../../../../main/ruby/drawings/core/text'
require_relative '../../../../main/ruby/drawings/core/circular_segment'
require_relative '../../../../main/ruby/drawings/core/bezier_curve'
...
class PartBComponentsInfo
  ...
  def image_pairs
    ...
    ["dan128", "ruby_logo"].each do |sub_path|
      path = "'https://www.cse.wustl.edu/~cosgroved/courses/cse425s/timeless/ruby/resources/#{sub_path}.png'"
      result.push(EvalTextImageSubPathPair.new("Image.new(#{path}, x: 0.5)", "Image#{result.length}"))
      result.push(EvalTextImageSubPathPair.new("Image.new(#{path}, y: -0.5)", "Image#{result.length}"))
      result.push(EvalTextImageSubPathPair.new("Image.new(#{path}, y: 0.3, x: -0.7)", "Image#{result.length}"))
    end
    result
  end
