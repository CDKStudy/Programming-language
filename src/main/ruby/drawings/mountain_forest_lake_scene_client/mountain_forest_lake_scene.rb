require_relative '../core/composite_transform'
require_relative '../core/equilateral_triangle'
require_relative '../core/rectangle'
require_relative '../core/ellipse'
require_relative '../core/bezier_curve'
require_relative '../core/circular_segment'
...
if __FILE__ == $0
  app = RenderClient.new(MountainForestLakeScene.new)
  app.main_loop
end