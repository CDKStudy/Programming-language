...
(assert-eval-equal? 
    120
    '(evaluate-in-empty-environment (LetExp "decrement" (FunctionExp "decrement" "y" (AddExp (IdentifierExp "y") (IntExp -1))) (LetExp "multiply" (FunctionExp "multiply" "x" (FunctionExp #f "y" (LetExp "helper" (FunctionExp "helper" "y" (IfGreaterExp (IdentifierExp "y") (IntExp 1) (AddExp (IdentifierExp "x") (CallExp (IdentifierExp "helper") (CallExp (IdentifierExp "decrement") (IdentifierExp "y")))) (IdentifierExp "x"))) (CallExp (IdentifierExp "helper") (IdentifierExp "y"))))) (LetExp "factorial" (FunctionExp "factorial" "n" (IfGreaterExp (IdentifierExp "n") (IntExp 1) (CallExp (CallExp (IdentifierExp "multiply") (IdentifierExp "n")) (CallExp (IdentifierExp "factorial") (CallExp (IdentifierExp "decrement") (IdentifierExp "n")))) (IntExp 1))) (CallExp (IdentifierExp "factorial") (IntExp 5))))))
   namespace
)
